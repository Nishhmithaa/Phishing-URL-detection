...
data = {'accuracy': [ SVM_accuracy, DT_accuracy, RF_accuracy, KN_accuracy],
        'precision': [ SVM_precision, DT_precision, RF_precision, KN_precision],
        'recall': [ SVM_recall, DT_recall, RF_recall, KN_recall]
        }
